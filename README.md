...
|| **Branch & User**        |v| PUT        || /Branch/:Id/AddUser                 || Adds a user to the specified branch. The Id in the URL, refers to the branch. The Id of the user is defined as a PUT field, in the request.              ||
...
|| **Course**     |v| GET        || /Courses                            || Returns the complete list of courses.                                                                                                                    ||
...
|| **Course & User**        |vvv| GET        || /CourseUserStatus/:CourseId,:UserId || Returns information about the status of a specified user in the specified course.                                                                        ||
...
|| **Curriculum & User**        |v| PUT        || /Curriculum/:Id/AddUser             || Adds a user to the specified curriculum. The Id in the URL, refers to the curriculum. The Id of the user is defined as a PUT field, in the request.      ||
...
|| **Group**      |v| GET        || /Groups                             || Returns the entire group list.                                                                                                                           ||
||                || GET        || /Group/:Id                          || Returns information about the group with the associated Id.                                                                                              ||                     
|| **Group & User**        |v| PUT        || /Group/:Id/AddUser                  || Adds a user to the specified group. The Id in the URL, refers to the group. The Id of the user is defined as a PUT field, in the request.                ||
...
|| **Plugin**     |vv| GET        || /Plugins                            || Returns a list of the available plugins and their information.                                                                                           ||
...
|| **User**   |vvvvvvvvv| GET  || /Autologin/:loginName || Returns the auto-login URL for the requested user.                                                                                                                                                                                                                         ||
